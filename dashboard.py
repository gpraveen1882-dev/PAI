...
def load_expansion():
    rows = [
        dict(country="Brazil",      c1=15.22,c2=15.18,c3=9.89,c4=9.99,c5=6.71,c6=6.07,score=11.53),
        dict(country="Ecuador",     c1=9.91, c2=10.04,c3=6.76,c4=7.54,c5=6.72,c6=5.29,score=8.18),
        dict(country="South Africa",c1=8.76, c2=9.06, c3=8.15,c4=8.52,c5=7.21,c6=7.80,score=8.39),
    ]
    df = pd.DataFrame(rows)
    df['tier'] = "Expansion"
    return df
