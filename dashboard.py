...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # Build display cols using only columns that exist in the dataframe
    col_map = {
    ...
    desired = ['Country','Organization Name','Category',
    ...
    display_df = filtered[avail].rename(columns=col_map)
    sort_col = 'Alignment' if 'Alignment' in display_df.columns else display_df.columns[0]
    st.dataframe(
        display_df.sort_values(['Country', sort_col], ascending=[True,False]),
