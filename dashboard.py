...
def page_header(title, subtitle=None, badge=None):
    badge_html = (
        '<span style="background:' + GREEN + '; color:white; padding:2px 12px;'
        ' border-radius:20px; font-size:0.68rem; font-weight:700; letter-spacing:1px;'
        ' margin-left:10px; vertical-align:middle;">'
        + badge + '</span>'
    ) if badge else ""
    sub_html = (
        '<div style="font-size:0.78rem; color:#CADCFC; margin-top:4px; font-weight:400;">'
        + subtitle + '</div>'
    ) if subtitle else ""
    html = (
        # Outer wrapper — full width, no border-radius so nothing clips
        '<div style="background:linear-gradient(135deg,' + NAVY + ' 0%,#243B6E 100%);'
        ' padding:0.9rem 1.4rem 0.85rem; margin-bottom:1.2rem;'
        ' border-bottom:3px solid ' + GREEN + ';">'

        # Row 1 — MI wordmark left · institution right
        '<div style="display:flex; justify-content:space-between; align-items:center;'
        ' margin-bottom:6px;">'
        '<div style="display:flex; align-items:center; gap:6px;">'
        '<span style="font-size:0.95rem; font-weight:900; color:white;">Mentors</span>'
        '<span style="font-size:0.95rem; font-weight:900; color:' + GREEN + ';">International</span>'
        '</div>'
        '<div style="font-size:0.65rem; color:#CADCFC; font-weight:500; letter-spacing:0.5px;">'
        'UCLA Anderson SICC &nbsp;·&nbsp; Spring 2026'
        '</div>'
        '</div>'

        # Row 2 — page title + optional badge
        '<div style="font-size:1.2rem; font-weight:700; color:white; line-height:1.25;">'
        + title + badge_html +
        '</div>'
        + sub_html +
...
# ══════════════════════════════════════════════════════════════════════════════
st.sidebar.markdown(
    '<div style="padding:1.4rem 0.8rem 0.8rem; text-align:center;">'
    '<div style="font-size:1.5rem; font-weight:900; color:white; letter-spacing:0.5px;'
    ' line-height:1.1;">Mentors</div>'
    '<div style="font-size:1.5rem; font-weight:900; color:#27AE60; letter-spacing:0.5px;'
    ' line-height:1.1; margin-bottom:8px;">International</div>'
    '<div style="height:2px; background:linear-gradient(90deg,#27AE60,#028090,transparent);'
    ' margin:0 0 8px; border-radius:2px;"></div>'
    '<div style="font-size:0.62rem; color:#CADCFC; letter-spacing:1.5px; font-weight:600;">'
    'GROWTH STRATEGY DASHBOARD</div>'
    '<div style="font-size:0.6rem; color:#445566; margin-top:3px;">'
