...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    st.dataframe(disp.style.background_gradient(subset=['Score (C1–6)'],cmap='Blues')
                 .format({'C1':'{:.2f}','C2':'{:.2f}','C3':'{:.2f}',
...
both the quantitative score and qualitative assessment.
        ...
        st.dataframe(rank_df.style
            .background_gradient(subset=['Score (C1–6)'],cmap='Blues')
            .format({'C1':'{:.2f}','C2':'{:.2f}','C3':'{:.2f}',
                    'C4':'{:.2f}','C5':'{:.2f}','C6':'{:.2f}','Score (C1–6)':'{:.2f}'}),
            use_container_width=True, hide_index=True)
