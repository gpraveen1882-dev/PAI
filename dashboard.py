...
def page_header(title, subtitle=None, badge=None):
    badge_html = (
        '<span style="background:' + GREEN + '; color:white; padding:3px 14px;'
        ' border-radius:20px; font-size:0.7rem; font-weight:700; letter-spacing:1px;">'
        + badge + '</span>'
    ) if badge else ""
    sub_html = (
        '<div style="font-size:0.76rem; color:#CADCFC; margin-top:3px;">'
        + subtitle + '</div>'
    ) if subtitle else ""
    html = (
        ...
        '<div style="border-right:2px solid rgba(255,255,255,0.15); padding-right:16px; line-height:1.1;">'
        '<div style="font-size:1.05rem; font-weight:900; color:white; letter-spacing:0.5px;">Mentors</div>'
        '<div style="font-size:1.05rem; font-weight:900; color:' + GREEN + '; letter-spacing:0.5px;">International</div>'
        '</div>'
        '<div>'
        '<div style="font-size:1.1rem; font-weight:700; color:white;">' + title + '</div>'
        + sub_html +
        '</div>'
        '</div>'
